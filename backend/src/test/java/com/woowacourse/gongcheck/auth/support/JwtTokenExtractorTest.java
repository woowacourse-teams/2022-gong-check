package com.woowacourse.gongcheck.auth.support;
...
class JwtTokenExtractorTest {
    ...
    void Authorization_헤더가_비어있으면_빈_값을_반환한다() {
        ...
        assertThat(JwtTokenExtractor.extractToken(httpRequest)).isEmpty();
    }
    ...
    void 토큰을_정상적으로_추출한다() {
        ...
        assertThat(JwtTokenExtractor.extractToken(httpRequest)).isEqualTo(Optional.of("jwt.token.here"));
    }
}
