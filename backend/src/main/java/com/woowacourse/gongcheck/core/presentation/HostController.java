...
import com.woowacourse.gongcheck.core.application.response.EnterCodeResponse;
...
public class HostController {
    ...
    @GetMapping("/hosts/enterCode")
    @HostOnly
    public ResponseEntity<EnterCodeResponse> showEnterCode(@AuthenticationPrincipal final Long hostId) {
        return ResponseEntity.ok(EnterCodeResponse.from(hostService.createEnterCode(hostId)));
    }
}
