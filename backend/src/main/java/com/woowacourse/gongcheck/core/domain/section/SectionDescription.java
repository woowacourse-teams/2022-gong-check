...
public class SectionDescription {
    ...
    public SectionDescription(final String announcement, final String imageUrl) {
    ...
    private void checkAnnouncementLength(final String announcement) {
        ...
        if (announcement.length() > ANNOUNCEMENT_MAX_LENTH) {
            throw new IllegalArgumentException("section의 설명은 " + ANNOUNCEMENT_MAX_LENTH + "자 이하여야합니다.");
        }
    }
    ...
    public boolean equals(final Object o) {
        ...
        final SectionDescription that = (SectionDescription) o;
